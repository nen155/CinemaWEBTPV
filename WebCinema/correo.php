  ...
  <div id="container">
    <div id="container_area">
      ...
      <div class="menu_pelicula_container">
        <div class="menu_pelicula_area correo">
          <div class="menu_pelicula_content correo">
            <div class="correo_text"> Introduce tu dirección de correo para finalizar la compra. </div>
            <div class="area_text_correo">
              <form class="form_correo" action='enviar.php' method='post'>
                <div >
                  <input class="text_area_correo" type='text' id='mail' name='mail' onkeydown='habilitar()' onkeyup='deshabilitar()' />
                </div>
                <div class="detail_button_area correo">
                  <input class="detail_button_compra correo" type='submit' name='submit' value='Enviar' id='confirmar'/>
                </div>
              </form>
            </div>
            <!--   <div class="detail_button_compra" id="buttonBuy" onclick="location.href=''" >ACEPTAR</div> --> 
          </div>
        </div>
      </div>
      <div id="footer_area">
