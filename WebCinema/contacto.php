...
<title>Correo -Theatrum Cinema</title>
  ...
  <div id="container">
    <div id="container_area">
      ...
      <div class="main_area butaca">
        <div class="menu_area cartelera">
          <div id="menu_content">
            ...
            <button type="button" name="" value="" class="button_menu_active contacto" onClick="location.href='contacto.php'">CONTACTO</button>
      ...
      <div class="menu_pelicula_container">
        <div class="menu_pelicula_area contacto">
          <div class="menu_pelicula_content contacto">
            <div class="autobus"></div>
            <div class="contacto_text">
              <ne>Autobuses:</ne>
              línea 666. Parada Infernal.</div>
            <div class="metro"></div>
            <div class="contacto_text">
              <ne>Metro:</ne>
              línea 001. Parada No tienes fé.</div>
            <div class="parking"></div>
            <div class="contacto_text">
              <ne>Parking:</ne>
              disponible gratuito presentando el ticket del cine.</div>
            <div class="relations"></div>
            <div class="line_sep"></div>
            <div class="contacto_text correo"> Contacta con nosotros para cualquier tema que nos quieras comentar.</div>
            <div class="mail_contacto"> </div>
            <div class="contacto_text mail">
              <ne>E-mail:</ne>
              <te><a href="mailto:cliente@theatrumcinema.com">atencion.cliente@theatrumcinema.com</a></div></te>
          </div>
        </div>
      </div>
      <div id="footer_area">
